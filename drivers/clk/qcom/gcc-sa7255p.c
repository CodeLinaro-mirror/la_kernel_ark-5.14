...
#include <dt-bindings/clock/qcom,sa7255p-gcc.h>
...
static struct clk_regmap *gcc_sa7255p_clocks[] = {
...
static const struct qcom_reset_map gcc_sa7255p_resets[] = {
...
static struct gdsc *gcc_sa7255p_gdscs[] = {
...
static const struct regmap_config gcc_sa7255p_regmap_config = {
	.reg_bits = 32,
	.reg_stride = 4,
	.val_bits = 32,
...
static const struct qcom_cc_desc gcc_sa7255p_desc = {
	.config = &gcc_sa7255p_regmap_config,
	.clks = gcc_sa7255p_clocks,
	.num_clks = ARRAY_SIZE(gcc_sa7255p_clocks),
	.resets = gcc_sa7255p_resets,
	.num_resets = ARRAY_SIZE(gcc_sa7255p_resets),
	.gdscs = gcc_sa7255p_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_sa7255p_gdscs),
};

static const struct of_device_id gcc_sa7255p_match_table[] = {
	{ .compatible = "qcom,sa7255p-gcc" },
	{ }
};
MODULE_DEVICE_TABLE(of, gcc_sa7255p_match_table);

static int gcc_sa7255p_probe(struct platform_device *pdev)
{
	struct regmap *regmap;
	int ret;

	regmap = qcom_cc_map(pdev, &gcc_sa7255p_desc);
	if (IS_ERR(regmap))
	...
	ret = qcom_cc_really_probe(pdev, &gcc_sa7255p_desc, regmap);
	if (ret) {
...
static struct platform_driver gcc_sa7255p_driver = {
	.probe = gcc_sa7255p_probe,
	.driver = {
		.name = "sa7255p-gcc",
		.of_match_table = gcc_sa7255p_match_table,
	},
};

static int __init gcc_sa7255p_init(void)
{
	return platform_driver_register(&gcc_sa7255p_driver);
}
core_initcall(gcc_sa7255p_init);

static void __exit gcc_sa7255p_exit(void)
{
	platform_driver_unregister(&gcc_sa7255p_driver);
}
module_exit(gcc_sa7255p_exit);

MODULE_DESCRIPTION("Qualcomm SA7255P GCC driver");
MODULE_LICENSE("GPL");
